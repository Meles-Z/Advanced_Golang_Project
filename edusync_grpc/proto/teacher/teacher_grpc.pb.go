...
const (
	TeacherService_CreateTeacher_FullMethodName  = "/edusync_grpc.TeacherService/CreateTeacher"
	TeacherService_GetAllTeachers_FullMethodName = "/edusync_grpc.TeacherService/GetAllTeachers"
	TeacherService_GetTeacherById_FullMethodName = "/edusync_grpc.TeacherService/GetTeacherById"
	TeacherService_UpdateTeacher_FullMethodName  = "/edusync_grpc.TeacherService/UpdateTeacher"
	TeacherService_DeleteTeacher_FullMethodName  = "/edusync_grpc.TeacherService/DeleteTeacher"
)
...
type TeacherServiceClient interface {
	...
	GetAllTeachers(ctx context.Context, in *GetAllTeachersRequest, opts ...grpc.CallOption) (*GetAllTeachersResponse, error)
...
func (c *teacherServiceClient) GetAllTeachers(ctx context.Context, in *GetAllTeachersRequest, opts ...grpc.CallOption) (*GetAllTeachersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllTeachersResponse)
	err := c.cc.Invoke(ctx, TeacherService_GetAllTeachers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TeacherServiceServer interface {
	...
	GetAllTeachers(context.Context, *GetAllTeachersRequest) (*GetAllTeachersResponse, error)
...
func (UnimplementedTeacherServiceServer) GetAllTeachers(context.Context, *GetAllTeachersRequest) (*GetAllTeachersResponse, error) {
...
func _TeacherService_GetAllTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAllTeachersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeacherServiceServer).GetAllTeachers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeacherService_GetAllTeachers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeacherServiceServer).GetAllTeachers(ctx, req.(*GetAllTeachersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeacherService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "edusync_grpc.TeacherService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TeacherService_GetAllTeachers_Handler,
		},
		{
